...
<td><input type="text" name="properties[page_subscriber]" id="properties_page_subscriber" value="<?php echo esc_attr( $this->properties['page_subscriber'] ); ?>" class="regular-text code<?php if ( ! $this->arrow_slash_in_login_path ) { echo ' slash_invalid'; }?>" />
<?php if ( ! $this->arrow_slash_in_login_path ) { echo '<p class="alert"></p>'; }?>
